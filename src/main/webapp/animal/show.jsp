...
<div class="myDiv" >
    <div >
        ...
        <div class="animal">
            ...
            <div class="group">
                <div class="animalX3">
                    <img src="../images/P7.jpg"><span>类型</span><br>
                    <p>${pet.petType}</p>
                </div>
                <div class="animalX4">
        ...
        <div class="animal_me">
            ...
            <div class="animal_me2"><p>大家好，我是${pet.petName}。${pet.remark}。你可以帮助我吗？</p></div>

        </div>
        <div class="my_btn">
            <button class="btn btn-primary btn-lg" id="pet_adopt_modal_btn">想要募捐</button>
