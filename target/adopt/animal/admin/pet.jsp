...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            <a class="navbar-brand" href="">公益募捐管理系统</a>
        </div>
        <!-- 导航栏右侧图标部分 -->
        <!-- 导航栏右侧图标部分 -->
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item my_font">
                            <a href="${pageContext.request.contextPath}/animal/admin/pet.jsp">
                                <i class="fa fa-sitemap fa-fw"></i> 募捐对象管理
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${pageContext.request.contextPath}/animal/admin/adopt.jsp">
                                <i class="fa fa-sitemap fa-fw"></i> 募捐管理
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                        ...
                        <li class="list-group-item my_font">
                            <a href="${pageContext.request.contextPath}/animal/admin/agree.jsp">
                                <i class="fa fa-sitemap fa-fw"></i> 同意募捐列表
                            </a>
                        </li>
                        <li class="list-group-item my_font">
                            <a href="${pageContext.request.contextPath}/animal/admin/disAgree.jsp">
                                <i class="fa fa-sitemap fa-fw"></i> 不同意募捐列表
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">募捐对象管理</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="panel-body">
                <form class="form-inline" method="get" action="#">
                    <div class="form-group">
                        <label for="findByPetType">募捐对象类型</label>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">募捐对象列表</div>
                    <!-- /.panel-heading -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">新建募捐对象信息</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="new_pet_form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_petName" placeholder="募捐对象名"
                                   name="petName">
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="new_petType" placeholder="募捐对象类型"
                                   name="petType">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" id="new_state" name="state">
                                <option value="0">还未被募捐</option>
                                <option value="2">被募捐</option>
                                <option value="1">被申请募捐</option>
                            </select>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="pet_save_btn">提交募捐对象信息</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabe">修改募捐对象信息</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="edit_pet_from" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_petName" placeholder="募捐对象名" value="${pet.petName}"
                                   name="petName">
                        </div>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_petType" placeholder="募捐对象类型" value="${pet.petType}"
                                   name="petType">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" id="edit_state" value="${pet.state}" name="state">
                                <option value="0">还未被募捐</option>
                                <option value="1">正在被募捐</option>
                                <option value="2">已经被募捐</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function build_pets_table(result){
        ...
        $.each(pets,function(index,pet){
            ...
            var stateTd=null;
            if(pet.state==0){
                stateTd=$("<td></td>").append("还未被募捐");
            }else if(pet.state==1){
                stateTd=$("<td></td>").append("正在被募捐");
            }else{
                stateTd=$("<td></td>").append("已经被募捐");
            }
